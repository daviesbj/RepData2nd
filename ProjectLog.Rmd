...
Matches('TROPI')
SumCat('TROPI')
c <- SetNew( c, 'TROPI', 'TROPICAL STORM' )
```

Can't just replace __TSTM__ with __TROPICAL STORM__, alas ...

```{r some tropical storms and others TSTM, cache = TRUE }
Matches('TSTM')
c <- SetNew( c, '^NON.TSTM', 'WIND' )
SumCat('TSTM')
c <- SetNew( c, 'TSTM', 'TROPICAL STORM' )
```
...
c <- SetNew( c, 'COLD', 'EXTREME COLD' )
c <- SetNew( c, 'LOW TEMPERATURE', 'EXTREME COLD' )
c <- SetNew( c, 'FOG', 'FOG' )
